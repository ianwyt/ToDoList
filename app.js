...
function renderComment(doc) {
    ...
    commentUsername.className = 'card-title';
    commentUsername.textContent = doc.data().username;

    let commentText = document.createElement('p');
    commentText.className = 'card-text';
    commentText.textContent = doc.data().comment;

    commentBody.appendChild(commentUsername);
